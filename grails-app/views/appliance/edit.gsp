...
<html>
	...
	<body>
		...
		<div id="edit-appliance" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${applianceInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${applianceInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:applianceInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${applianceInstance?.version}" />
				<fieldset class="form">
