...
@Mock([Reservation, Person, Appliance])
class ReservationControllerSpec extends Specification {

    def populateValidParams(params) {
        assert params != null
        params.who = new Person(name:'山田').save()
        params.what = new Appliance(name:'プロジェクタ1').save()
        params.fromDate = new Date(115, 7, 1, 9, 0)
        params.toDate = new Date(115, 7, 1, 12, 0)
    }
